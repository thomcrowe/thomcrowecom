  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Thom -husband, father armchair theologian and digital marketer in Tulsa, Oklahoma."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Thom, a digital marketer by day and armchair theologian, podcaster, writer, amateur home chef, and beer aficionado by night. When not working, I&apos;m a typical family man with a propensity to create.
          </p>
