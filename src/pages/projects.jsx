...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Side Projects - Thom Crowe</title>
        <meta
          name="description"
          content="."
        />
      ...
      <SimpleLayout
        title="Some of the projects I build and contribute to on the side."
        intro="I've worked on quite a few side projects for fun over the years - these are some of my favorites. I get to spend time with friends, contribute to larger communithies">
        <ul
          role="list"
